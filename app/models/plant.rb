class Plant < ApplicationRecord
  ...
  class << self
    def send_watering_reminder_for(user)
      ...
      title = I18n.t("activerecord.models.plant.watering_reminder_title")
      body = I18n.t("activerecord.models.plant.watering_reminder", count: plants_count, display_name: plants.first.display_name(with_prefix: true))
